...
const startStr = '    private fun buildWhatsAppStyleUI(';
const endStr = 'setContentView(root)\n    }';
...
const newUI = \    private fun buildWhatsAppStyleUI(
        ...
        val declineBtn = FrameLayout(this).apply {
            ...
            background = GradientDrawable().apply {
                shape = GradientDrawable.OVAL
                setColor(Color.parseColor("#1E1E28"))
            }
            setOnClickListener {
...
const finalCode = code.substring(0, startIndex) + newUI + code.substring(endIndex);
