...
export default function MatchesScreen() {
  ...
  const borderCol = isDarkMode ? 'rgba(255, 255, 255, 0.12)' : 'rgba(15, 23, 42, 0.06)';
  ...
  return (
    <SafeAreaView style={[styles.safeArea, { backgroundColor: bg }]}>
      ...
      <View style={styles.container}>
        ...
        <View style={[styles.tabToggleRow, { backgroundColor: isDarkMode ? '#000000' : 'rgba(15, 23, 42, 0.04)', borderColor: borderCol }]}>
          <TouchableOpacity
